...
// Teensy MicroMod has 1 board LED
...
// UART config: 7 UARTs at the pins for Teensy 4.1
#define MICROPY_HW_UART_NUM     (sizeof(uart_index_table) / sizeof(uart_index_table)[0])
// Note Serial2 and Serial4 on MMOD switch which pins are used.
#define MICROPY_HW_UART_INDEX   { 0, 6, 3, 2, 4, 8, 1, 7 }
...
// Wire Wire1/Wire2 are swapped on MMOD vs T4.1...
#define MICROPY_HW_I2C_INDEX   { 1, 4, 3 }
...
#define MICROPY_HW_TEMPMON_AVAIL 1